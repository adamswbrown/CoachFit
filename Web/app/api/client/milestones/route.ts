 ...
 *
 * Returns achieved milestones for the authenticated client.
 * Auth: X-Pairing-Token or Clerk session.
 */

import { NextRequest, NextResponse } from "next/server"
import { db } from "@/lib/db"
import { handleIngestPreflight } from "@/lib/security/ingest-auth"
