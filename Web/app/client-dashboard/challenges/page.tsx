      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-10 text-center">
            ...
            <p className="text-sm font-medium text-neutral-700">No active challenge</p>
            <p className="text-xs text-neutral-500 mt-1">Speak to your coach to get enrolled in a challenge.</p>
          </div>
        ) : (
          <div className="grid gap-4 sm:grid-cols-2">
