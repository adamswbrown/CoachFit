...
export default function EditCreditProductPage() {
  ...
  const loadProduct = useCallback(async () => {
    ...
    try {
      const res = await fetch(`/api/credits/products/${productId}`, {
        credentials: "include",
      })
      if (!res.ok) {
      ...
      setForm({
        ...
        creditsPerPeriod: product.creditsPerPeriod != null ? String(product.creditsPerPeriod) : "",
        periodType: product.periodType,
        purchasePriceGbp: product.purchasePriceGbp != null ? String(product.purchasePriceGbp) : "",
        appliesToClassTypes: (product.appliesToClassTypes ?? []).join(", "),
        ...
        rolloverPolicy: product.rolloverPolicy ?? "NONE",
      })
    } catch (err) {
  ...
  if (status === "loading" || (status === "authenticated" && form === null && loadError === null)) {
    return (
      <CoachLayout>
      ...
      <CoachLayout>
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6">
          ...
          <a
            ...
            className="inline-block mt-4 text-sm text-neutral-600 underline hover:no-underline"
          >
    ...
    <CoachLayout>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-semibold text-neutral-900">Edit Credit Product</h1>
          <p className="text-sm text-neutral-600 mt-1">
            Update the details of this credit pack.
          </p>
        </div>
