...
function LoginPageContent() {
  ...
  useEffect(() => {
    ...
    } else if (errorParam === "InvalidCheck" || errorParam === "OAuthCallback" || errorParam === "Callback") {
      setError("Google sign-in expired or was interrupted. Please try again.")
    } else if (errorParam === "Configuration") {
      setError("Google sign-in is not available right now. Use email/password or contact support.")
