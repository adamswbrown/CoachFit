...
<p>We collect information you provide directly (email, name, fitness data) and information automatically collected through our service (usage data, device information).</p>
<h3>2. HealthKit Data</h3>
<p>When you connect HealthKit, we collect steps, workouts, sleep, and other health metrics. You can disconnect HealthKit integration at any time.</p>
<h3>3. Data Usage</h3>
<p>We use your data to provide fitness tracking, coach feedback, analytics, and service improvements. We do not sell your personal data to third parties.</p>
...
<p>You have the right to access, export, and delete your data. You can exercise these rights through your account settings or by contacting us.</p>
